...
namespace WebVPP.Areas.Admin.Controllers
{
    ...
    public class AdminAccountController : Controller
    {
        ...
        public AdminAccountController(BtVppContext context)
        {
            _context = context;
        }
        ...
        {
            var btVppContext = _context.Accounts.Include(a => a.Role);
            return View(await btVppContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("AccountId,FullName,RoleId,PassWord")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,FullName,RoleId,PassWord")] Account account)
        {
